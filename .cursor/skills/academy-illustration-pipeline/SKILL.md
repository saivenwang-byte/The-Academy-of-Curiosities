...
| # | 铁律 |
|---|------|
| 1 | **插图服务已定稿正文** — 分镜 `原文范围` 必须链 Hybrid Voice **CN 或 JP 定稿段落** |
...
Phase 4  JP 定稿（academy-jp-voice-editor · 田中 E04/E07）← **G-JP · 插画气泡/屏显字锁**
Phase 5  Shot Map / 分镜头与插页地图（**G-CN 后起草 · G-JP 后定稿字字段**）
...
最后更新：2026-06-08 · V1.0 流程继承 · V2 机制替换
