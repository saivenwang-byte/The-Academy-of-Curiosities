...
CASES = [
    {
        ...
        "illus": [
            ("V-S01-V2-A1_广播响起_PRODUCT_c01.png", "A001 · 放送 · 唇が合わない"),
            ("V-S01-V2-A1_广播响起_PRODUCT_c02.png", "A001 · 放送 · 第二角度"),
        ],
        "illus_subdir": "案01",
    ...
    },
    {
        ...
        "illus": [
            ("V-S02-V2-A1_黑板对不起_PRODUCT_c01.png", "A002 · 黒板 · SC-02"),
            ("V-S02-V2-A3_膜边反光_PRODUCT_c01.png", "A002 · 膜の端 · SC-05"),
        ],
        "illus_subdir": "案02",
    ...
    },
    {
        ...
        "illus": [
            ("V-S03-V2-DEMO_空海报位_PRODUCT_c01.png", "A003 · 空欄 · SC-01"),
            ("V-S03-V2-A4_远标题连线_PRODUCT_c01.png", "A003 · 遠タイトル · SC-04"),
        ],
        "illus_subdir": "案03",
    ...
    },
    {
        ...
        "illus": [
            ("V-S04-V2-A1_抽屉失物_PRODUCT_c01.png", "A004 · 引き出し · SC-02"),
            ("V-S04-V2-A3_倾斜水泡_PRODUCT_c01.png", "A004 · 傾き水準器 · SC-05"),
            ("V-S04-V2-A4_振动复现_PRODUCT_c01.png", "A004 · 振動再現 · SC-07"),
        ],
        "illus_subdir": "案04",
    ...
    },
    {
        ...
        "illus": [
            ("V-S05-V2-A1_仅水野无影_PRODUCT_c01.png", "A005 · 影なし · SC-01 · EXPERT_LOCK"),
            ("V-S05-V2-A6_重拍有影_PRODUCT_c01.png", "A005 · 再撮影 · SC-08"),
        ],
        "illus_subdir": "案05",
