...
def build_a001_html() -> str:
    css = load_css()
    jp_raw = bde.strip_txt_meta(bde.read_text(JP_A001))
...
def main() -> int:
    ...
    parser.add_argument("--scope", choices=["a001", "vol1"], default="a001")
    ...
    stem = f"学堂奇事録_Vol1_Reader_序+A001_日本語_{OUT_DATE}"
    html_path = OUT_DIR / f"{stem}.html"
    pdf_path = OUT_DIR / f"{stem}.pdf"

    html_path.write_text(build_a001_html(), encoding="utf-8")
