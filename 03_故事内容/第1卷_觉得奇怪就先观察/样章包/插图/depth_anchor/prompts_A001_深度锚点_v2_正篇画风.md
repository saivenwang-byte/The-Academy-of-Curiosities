# A001 深度锚点 · 生图 Prompt · v2（正篇画风）

> **Status**: **v0.2 探索稿已生成** · 2026-06-05  
> **画风 LOCK**: **用户正篇画风设定 Sheet** · `07_设计原档/04_样章视觉/Vol1_正篇画风_角色设定Sheet_用户参考_v1.png`  
> **替代**: v1 之 L0 Style A 温暖水彩（本批废止）  
> **产出**: 本目录 6 PNG · v0.2 探索
...
**共用负面词**: watercolor wash, rough pencil sketch only, chibi SD, horror, ghost, Chinese classroom, detective trench coat, dark scary lighting, English main text, watermark, fluorescent colors

**四人识别（正篇画风 Sheet LOCK · 案① 无瑆/理紗）**:
- **伊藤光**: 橙红运动外套 · 刺猬棕发 · 哨子/活力 · 硬壳本
- **加藤慧美**: 黄开衫 · **低侧马尾+耳侧短辫+柔黄发带** · 银框镜 · 采访本
- **松本志郎**: **红T+绿背心** · 圆框镜 · 矮壮 · 查证卡
- **陸珣**: 蓝卫衣+黄内搭 · 乱黑发 · 路线地图本 · 侧后冷静位
...
| # | ID | 状态 |
|---|-----|------|
| 1 | DA1 | ✅ `V-S01-A1_侧廊发现_v0.2.png` |
| 2 | DA2 | ✅ `V-S01-A2_误导搜查_v0.2.png` |
| 3 | DA3 | ✅ `V-S01-A3_风侧线索_v0.2.png` |
| 4 | DA4 | ✅ `V-S01-A4_验证收束_v0.2.png` |
| 5 | DB1 | ✅ `V-S01-B1_风侧机制图_v0.2.png` |
| 6 | DC1 | ✅ `V-S01-TAIL_壁报空栏_v0.2.png` |
...
```
Clean bridge-book science infographic insert, soft flat-graphic hand-drawn style matching main story color palette cream paper #F7F3EE, 4:3 horizontal. Japanese labels: (1) 出風口と窓のすきま gentle airflow arrows; (2) 雨の日・湿度 humidity cloud paper curl; (3) 貼り方・フォルダー folder shield diagram. Pastel blue green amber, sticker-like clarity NOT textbook PPT, NO horror NO Chinese main text, warm friendly elementary science.
```

### DC1 · 壁报空栏尾钩

```
Bridge-book anime quarter close-up warm light 4:3. Clipboard wall newspaper draft kraft texture, three columns pencil Japanese めくれたポスター 検証・フォルダーで風よけ, fourth column BLANK tiny question mark. Witness line 陸珣・風側 small. Child hand pencil bottom edge optional. NO submission slip. Cozy hook mood clean line art painterly color.
```
