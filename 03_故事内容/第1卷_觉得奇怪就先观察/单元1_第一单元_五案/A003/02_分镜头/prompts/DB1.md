# A003 · DB1 · Prompt · V3.6

> **Status**: G1DRAFT_PRODUCTION · 试读 PDF 用  
> **Shot Map**: [`03_分镜头_插页地图_V3.9_JP.md`](../03_分镜头_插页地图_V3.6_JP.md)  
> **正文锚**: [`../01_正文/案03_每个人都记得的海报_HybridVoice_V3.9_日本語.txt`](../01_正文/案03_每个人都记得的海报_HybridVoice_V3.9_日本語.txt)
...
| 画中文字 | **指定日文**： |
| 重绘 | ⚪ |
| JP V3.9 锚句 | 「慧美が止まる。ポスターを覚えていることは否定しない。別のことを否定する：「……貼り終わっていない。」 |
...
| 第二信息 | 日文简图 |
| 服道化 | B轨 |
| JP 锚点句 | 慧美が止まる。ポスターを覚えていることは否定しない。別のことを否定する：「……貼り終わっていない。 |
...
scene context: 慧美が止まる。ポスターを覚えていることは否定しない。別のことを否定する：「……貼り終わっていない。」...
[NEGATIVE]
```
