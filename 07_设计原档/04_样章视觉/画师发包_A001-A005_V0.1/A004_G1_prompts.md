...
| 字段 | 值 |
|------|-----|
| 镜头编号 | **V-S04-V2-A1 / DA1** |
| 镜头功能 | **S+L** |
| 景别 | **MS–CU** |
| 机位 | 失物柜平视略俯 |
| 视觉中心 | **半开抽屉** · 失物堆 · 封条完好 |
| 第二信息 | 水野 **两步外 · 手无钥匙** · 珣廊边 |
| 场景 | 失物柜走廊 · 公开日标签 · **上履き** |
| 禁项 | 粉笔灰圈 · 撬锁痕 · villain 水野 · 制服 |
...
| 字段 | 值 |
|------|-----|
| 镜头编号 | **V-S04-V2-A3 / DA3** |
| 镜头功能 | **L+C** |
| 景别 | **MCU** |
| 机位 | **柜顶 POV** · 水平仪 |
| 视觉中心 | FC-2 **水平仪水泡偏一格** · 柜倾斜可读 |
| 第二信息 | FC-3 振动日志时刻表 · 志郎粉笔标记低侧 |
| 正文锚点 | 「水泡偏了——不是 eye 错觉。」 |
...
## DA4 · 振动复现 · SC-05–07 · P0

### §11 分镜规划书

| 字段 | 值 |
|------|-----|
| 镜头编号 | **V-S04-V2-A4 / DA4** |
| 镜头功能 | **L+P** |
| 景别 | **MS** |
| 机位 | 走廊 · 器材车过门槛 |
| 视觉中心 | 器材车过 · **柜震** · 最下抽屉先有物滑动 |
| 第二信息 | 慧美四栏本确认列 · 水野手无钥匙 |
| 正文锚点 | 「车一过，最下面那格先响。」 |
| G-BODY锚 | A001/A005器材车一致·间接振动 |

### 合成 Prompt（G1 · c02）

```
[STYLE] MS corridor equipment cart wheel at threshold floor slight bounce motion line,
bottom drawer items sliding tilted locker Keimi four-column notebook confirmed column yellow cardigan silver glasses,
Riku Shun blue hoodie noting cabinet gap uwabaki,
Mizuno Maho hands empty NO key casual clothes,
Matsumoto Shiro green plaid green vest at cart,
fair-play indirect vibration mechanism NOT cart-direct-cause caption,
Nagoya hallway April NOT seifuku bridge-book watercolor #2A1810
