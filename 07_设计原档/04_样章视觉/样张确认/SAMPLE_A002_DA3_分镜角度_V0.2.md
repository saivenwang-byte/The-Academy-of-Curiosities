# SAMPLE · A002 · DA3 · 分镜角度 · V0.2-SAMPLE

> **Status**: **SAMPLE-GATE · READY FOR IP SIGN** · 2026-06-09  
> **前版**: V0.1 · 机位/POV PASS 基线 · **L0 partial 升级 V0.3 slot②③**  
> **用途**: Vol1 Unit1 插画 batch **第二** 试跑帧 · 验证 **机位/景别/POV** 纪律  
> **案**: A002 · SC-05 · **V-S02-V2-A3 / DA3**  
> **输出**: `03_故事内容/第1卷_觉得奇怪就先观察/样章包/插图/样张确认/SAMPLE_A002_DA3_分镜角度_V0.2.png`  
> **L0 SSOT**: [`CHAR_lineup_L0_修正_V0.3_全景.png`](../CHAR_lineup_L0_修正_V0.3_全景.png)  
> **前版样张**: [`SAMPLE_A002_DA3_分镜角度_V0.1.md`](./SAMPLE_A002_DA3_分镜角度_V0.1.md)  
...
| 项 | V0.1 | V0.2 |
|----|------|------|
| **L0 参照** | `CHAR_lineup_L0_专家共识_画师发包_3840.png` | **`CHAR_lineup_L0_修正_V0.3_全景.png`** |
| **珣 partial** | 藏青袖+白上履き · V0.2 手术块 | **+ 背包带角 #505050 · 黄内袖缘 · 禁蓝带上履き** |
| **志郎 partial** | 绿格+绿 vest | **同 V0.3 slot③ · 不变** |
| **机位/机制/画风** | PASS 基线 | **不变** |
...
| 禁项 | character lineup board · height measure · portrait grid · 鬼怪 · 制服 · 6年2組门牌 · **lineup poster** |

---

## 2. 机位纪律 · P0（本样张核心 · 同 V0.1）
...
## 3. STYLE_LOCK · A 轨（继承 DA1 PASS · doc65 §3）
...
## 4. L0 角色锁（E06-S · V0.3 partial 出场）

**垫图 mandatory**: [`CHAR_lineup_L0_修正_V0.3_全景.png`](../CHAR_lineup_L0_修正_V0.3_全景.png)

| Slot | 角色 | 本帧可见部位 | L0 P0（V0.3） |
|:----:|------|-------------|---------------|
| **②** | **陸 珣** Riku Shun | 右手/前臂 · 鞋缘 · 背包带角 | **142cm** · 藏青 **zip 外套 NO hood** `#3A5080` · 黄内衬袖缘 `#E8C848` · **深灰背包带 #505050** 可选角 · **白袜+纯白上履き** 禁蓝带 · 食指指向膜边 · 手 **不插兜** |
| **③** | **松本 志郎** Matsumoto Shirō | 左缘 partial 前臂/袖（演示边） | **145cm 矮壮** · **绿格衬衫 + 绿 utility vest** · 圆框镜可虚化 · 持清洁布角 |

**本帧不出**: 慧美⑦ · 光④ · 瑆① · 全班 · **lineup poster**
...
| 机制 | **膜边反光细线** = FC-1 · 清洁液 = FC-3 时序种子 · **禁** ごめんなさい。占满画幅 |
...
| 样品袋 = 空白手写标签 **形状** only | 学堂趣事录 · 5年2组 · 身長測定 · lineup poster |
...
```
[NEGATIVE KF-LOCK-J++ SAMPLE GATE DA3 V0.2 ANGLE]
...
character lineup board, height chart, portrait grid, roster poster, 身長測定, 11 slots student wall, lineup poster,
...
Riku hoodie hood visible, hands in pockets, spiky hair, blue uwabaki strap colored toe cap, dark crew socks,
Matsumoto in green cleaning mesh vest instead of L0 plaid, full blackboard apology text stealing frame
```

---

## 8. 合成 Prompt · V0.2-SAMPLE（一键复制）

```
A-TRACK Vol1 SAMPLE A002 DA3 board-slot POV ECU angle discipline V0.2 L0 V0.3,
...
Riku Shun slot2 V0.3 partial: navy zip jacket sleeve #3A5080 NO hood yellow inner cuff #E8C848,
dark gray backpack strap corner #505050 optional, index finger pointing at film glint NOT in pockets,
plain white uwabaki toe edge bottom frame white socks NO blue strap NO colored toe cap,
...
5年2組 Nagoya RC classroom April fair-play film clue NOT ghost writing NOT lineup NOT height chart NOT lineup poster,
...
Match Riku sleeve backpack strap and Shirou vest to CHAR_lineup_L0_V0.3 slots 2 and 3 partial only.

[NEGATIVE KF-LOCK-J++ DA3 V0.2] simplified Chinese 对不起 ごめんなさい 学堂趣事录 lineup board height chart portrait grid lineup poster,
MS flat blackboard three-shot full body queue 6年2組 seifuku chibi SD infographic English UI speech bubbles,
hoodie hood hands in pockets blue uwabaki strap colored toe cap Chinese classroom ghost writing apology text full frame
```
...
| C1–C2 | 珣袖/指/上履き L0 V0.3（无帽·白袜·无蓝带·背包带角）· 志郎绿格+绿 vest partial |
...
| 4 | **L0 partial V0.3** | 珣藏青无帽袖+黄缘+白上履き · 志郎绿格+绿 vest 缘 |
| 5 | **画内文字** | 零可读字 · 零中文 |
| 6 | **机制** | 膜边反光细线清晰 · 非 ghost · 非 lineup |
| 7 | **流程** | 与 DA1 V0.3 双签后解锁 batch |

**签栏**: IP Owner ☐ · visual-auditor ☐ · 日期 ______

---

*V0.2-SAMPLE · V0.3 L0 partial 对齐 · A002 DA3 板槽 POV · batch 仍冻结待 IP 三签。*
